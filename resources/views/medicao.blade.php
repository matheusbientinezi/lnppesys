<x-app-layout>
                                ...
                                <div id="accordion-collapse-1-linha" data-accordion="">
                                    <table
                                        ...
                                        <thead
                                            ...
                                            <tr>
                                                <th scope="col" class="px-6 py-3" width="10px">NÂº</th>
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ url('insertDadosMedicaoEtapa1') }}"
                                                                    ...
                                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                                        ...
                                                                        <div>
                                                                            <label for= "penalidade_peixe_1_{{ $list1['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade Peixe 1 ( cm )</label>
                                                                            <input type="number"
                                                                        ...
                                                                        <div>
                                                                            <label for= "penalidade_peixe_2_{{ $list1['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade Peixe 2 ( cm )</label>
                                                                            <input type="number"
                                                                        ...
                                                                        <div>
                                                                            <label for= "penalidade_peixe_3_{{ $list1['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade Peixe 3 ( cm )</label>
                                                                            <input type="number"
                                                                        ...
                                                                        <div>
                                                                            <label for= "penalidade_peixe_4_{{ $list1['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade Peixe 4 ( cm )</label>
                                                                            <input type="number"
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                for="penalidade_1_{{ $list1['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade Chegada
                                                                                ( cm )</label>
                                                                            <input type="number"
                                                                                id="penalidade_1_{{ $list1['id'] }}"
                                                                                value=""
                                                                                class="penalidade_1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                                                placeholder="Peixe 5">
                                                                        </div>
                                                                        <div>
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ url('insertDadosMedicaoEtapa1') }}"
                                                                    ...
                                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                for="penalidade_1_{{ $list3['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade
                                                                                ( cm )</label>
                                                                            <input type="number"
                                                                                id="penalidade_1_{{ $list3['id'] }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ url('insertDadosMedicaoEtapa1') }}"
                                                                    ...
                                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                for="penalidade_1_{{ $list4['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade
                                                                                ( cm )</label>
                                                                            <input type="number"
                                                                                id="penalidade_1_{{ $list4['id'] }}"
                                                            ...
                                                            <div
                                                                ...
                                                                <form action="{{ url('insertDadosMedicaoEtapa1') }}"
                                                                    ...
                                                                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                                                                        ...
                                                                        <div>
                                                                            <label
                                                                                for="penalidade_1_{{ $list5['id'] }}"
                                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Penalidade
                                                                                ( cm )</label>
                                                                            <input type="number"
                                                                                id="penalidade_1_{{ $list5['id'] }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.penalidade_1').on("input", function() {
                var valueInput = this.value;
                var id = this.id;
                var idSplited = id.split('_')
                var idLinha = idSplited[2]
        ...
        function somaTotal(value, id) {
            ...
            var penalidade_1 = $("#penalidade_1_" + id).val();
        ...
        function sendForm(id) {
            ...
            var penalidade_1 = $("#penalidade_1_" + id);
            var total = $("#total_" + id);
            ...
            var erromsg = '<div class="erromsg" style="color: red;"> Campo ObrigatÃ³rio! Se necessÃ¡rio, inserir 0.<span></span></div>';
        ...
        function getPDF(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    link.download = "medicao_equipe_" + numequipe + ".pdf";
                    link.click();
                },
                error: function(blob) {
                    console.log(blob);
